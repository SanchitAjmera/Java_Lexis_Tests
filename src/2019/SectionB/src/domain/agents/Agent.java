...
public abstract class Agent extends Thread {
    ...
    private int sampleExponentialWaitingTime() {
        // In case you are curious, the exponential distribution is the
      // simplest statistical model for
        // used to represent waiting times. Can be used when only the average
      // inter-arrival time (or
        // the arrival frequency is available), fo example, if you only know
      // that bus 74 passes every
